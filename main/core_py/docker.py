...
cmds = {
    'ubuntu' : 'docker run -d -h core --cap-add NET_ADMIN --cap-add SYS_MODULE --sysctl net.ipv6.conf.all.disable_ipv6=0 --sysctl="net.ipv4.conf.all.src_valid_mark=1" -e PRIVATE_KEY={} -e IP={} -e USER={} core_ubuntu:alpha',
    'debian' : 'docker run -d -h core --cap-add NET_ADMIN --cap-add SYS_MODULE --sysctl net.ipv6.conf.all.disable_ipv6=0 --sysctl="net.ipv4.conf.all.src_valid_mark=1" -e PRIVATE_KEY={} -e IP={} -e USER={} core_debian:alpha',
